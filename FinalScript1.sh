...
#CSV File
CSVFile=/home/ubuntu/EDM_Agent_Automation/CSVFiles/EDM_RECORDS_WITH_CURRENCY_SYMBOLS_SUPPORTED.csv
#Spooling Directory Path
SpoolDirPath=/home/SpoolDir1
#Current Time
...
sudo chown ccns:ccns -R $SpoolDirPath/* ; sudo chmod 755 -R $SpoolDirPath/*
